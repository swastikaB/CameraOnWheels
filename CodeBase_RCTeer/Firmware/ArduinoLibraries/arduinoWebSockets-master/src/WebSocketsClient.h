...
class WebSocketsClient: private WebSockets {
    public:
        ...
        bool sendTEXT(uint8_t * payload, size_t length = 0, bool headerToPayload = false);
        bool sendTEXT(const uint8_t * payload, size_t length = 0);
        bool sendTEXT(char * payload, size_t length = 0, bool headerToPayload = false);
        bool sendTEXT(const char * payload, size_t length = 0);
        bool sendTEXT(String & payload);

        bool sendBINARY(uint8_t * payload, size_t length, bool headerToPayload = false);
